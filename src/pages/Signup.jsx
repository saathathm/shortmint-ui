...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!result.error) navigate('/pricing')
  }
    ...
    <div className="min-h-[80vh] flex items-center justify-center">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-text-muted mt-1 text-sm">Start turning long videos into viral Shorts</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} className="input-field pr-10" placeholder="Min. 8 characters" minLength={8} required />
            ...
            {error && <div className="bg-red-50 border border-red-100 text-error text-sm rounded-xl p-3">{error}</div>}
