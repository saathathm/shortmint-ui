...
<div className="card p-5 mb-8 border-dashed border-2 border-border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
  <div>
    <div className="flex items-center gap-2 mb-1">
      <h2 className="font-bold text-text-primary">Free Trial</h2>
      <span className="text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full font-semibold">No card required</span>
    </div>
    <p className="text-sm text-text-muted">Try ShortMint before you commit.</p>
  ...
  <div className="shrink-0">
    {!isAuthenticated ? (
      ...
      <span className="text-xs text-text-dim">Already upgraded</span>
    )}
  </div>
</div>
